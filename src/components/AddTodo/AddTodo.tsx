...
const AddTodo = () => {
  ...
  if (!isOpened) return <div className=" rounded-lg p-4 m-4 bg-white hover:scale-110 active:scale-90 duration-500" onClick={() => setIsOpened(true)}><Text type="heading">+</Text></div>;
  return (
